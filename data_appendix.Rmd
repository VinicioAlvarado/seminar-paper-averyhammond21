...
oz_weather_data <- left_join(oz_hourly, weather_hourly)

oz_regression_data <- left_join(oz_weather_data, distance_list)
```

```{r test running oz regression}

oz_regression_results <- lm(ozone ~ after + hour*after + exposed + exposed*after + TMP1, 
