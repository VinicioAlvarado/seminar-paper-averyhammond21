...
stargazer(nox_3month_regression_results, type = "text",
          report = 'vctp',
          intercept.bottom = F,
          header = F,
          digits = 5)
