---
title: "The Impact of Public Transit Expansion on Individual Air Pollutants in Houston, Texas"
...
This study also uses cross-sectional data on the locations of Houston Metro stations to analyze the Metro's impact on air quality in these areas, retrieved from the City of Houston GIS database (City of Houston, 2019). I use the coordinates of the new METRO Rail stations and the site data of air quality monitors to compute the minimum distances between each METRO station and the city's air quality monitors. From this, the "exposed" dummy variable was created for air quality monitors within 10.5 kilometers of a new METRO station. It is also noteworthy that not all air quality monitors measure every pollutant used in this study, which accounts for the variation in N-values in the summary tables. Table \ref{variabledefinitions} provides definitions for the variables used in this analysis.
...
The results of all pollutant regressions can be found on Table \ref{regressionresults}. With the exception of $PM_{2.5}$, all coefficients of $after*exposed$ are statistically significant. These results suggest that in the year following Houston METRO Rail expansion, air quality monitors inside a 10.5 kilometer radius of new subway stations experienced subsequent concentration reductions in nitrogen oxides, carbon monoxide, and sulfur dioxide by 8.61%, 36.14%, and 7.22% respectively. As I hypothesized in the Data and Methods section, individual pollutants experienced varying levels of reduction in the year following the introduction of the METRO Rail, with the difference in $PM_{2.5}$ being insignificant entirely. The low $R^2$ values suggest that much of the variation in the pollutant variables is not accounted for by the independent variables used in this regression. Other potentially influential explanatory variables include precipitation and humidity, the data for which was unavailable at the time of this study.

The pollutant that experienced by far the largest reduction as a result of subway expansion is carbon monoxide, the greatest source of which is motorized vehicles that burn fossil fuel (US EPA, 2016). These findings resemble those of Zheng et al. (2019) and Bel et al. (2018), both of whom find significant reductions in carbon monoxide in areas located near new or expanded public transit. Reductions in carbon monoxide are especially noteworthy, as its effects on human health are the most severe out of all pollutants included in this study (US EPA, 2016). Because elevated concentrations of $NO_x$ and $SO_2$ can cause long-term respiratory effects, the reduction of these pollutants are also meaningful within a public health context (US EPA 2016). 

The significant reductions in these particular pollutants further support the findings of Zheng et al. (2019) and many other studies, which theorize that the improvements in air quality as a result of public transport expansion may be caused by the substitution of private vehicles for public, therefore causing fewer emissions. The results of this regression indicate that the expansion of public transit causes lower air pollutant concentrations in at least one U.S. city in the medium-term, and that the findings of similar research in other countries may be applicable to parts of the United States. 



# Conclusion

This brief section will summarize the main conclusions of the paper, offer concluding comments and may include some discussion of caveats, possible next steps for someone interested in your research *topic*, and any policy or other implications you wish to discuss.
